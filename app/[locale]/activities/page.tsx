...
const ActivitiesMap = dynamic(() => import("@/components/Activities/ActivitiesMap"), { ssr: false });
...
export default function HomePage() {
    ...
    return (
        <div className="flex flex-col gap-4 p-4 h-screen">
            <SplitText
                text={t("Heading")}
                className="text-4xl md:p-3 mt-20 md:mt-0 tracking-wide md:text-6xl text-cyan-500 font-extrabold text-shadow-sm font-inter "
                delay={100}
                duration={0.6}
                ease="power3.out"
                splitType="chars"
