...
function Cluster({ restaurants }: { restaurants: Restaurant[] }) {
    ...
    useEffect(() => {
        ...
        restaurants.forEach((act) => {
            const marker = L.marker([act.lat, act.lng]);

            const popupContent = `
                <div class="restaurantRestaurant-popup" data-id="${act.id}" 
            ...
            marker.on("popupopen", (e) => {
                ...
                const clickable = popupEl?.querySelector(".restaurantRestaurant-popup");
...
function MapEventHandler() {
    const { setMapBounds, mapBounds } = useRestaurantFilterStore();
