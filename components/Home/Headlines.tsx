...
const Headline = ({ item, reverse }: { item: Item, reverse: boolean }) => {
    ...
    return (
        <section className="h-[50vh] snap-center md:m-10 pt-20 md:pt-10 relative">
            <div
        ...
        flex-col md:flex-row`}
            >
                <div ref={ref} className="flex-1 h-full relative w-full">
                    <div className="hidden md:block absolute top-4 left-4 w-full h-full bg-cyan-500 rounded-2xl md:rounded-3xl"></div>
                    <Image
                        fill
