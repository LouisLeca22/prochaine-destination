...
function MapChart() {
    ...
    return (
        <ComposableMap
            ...
            className="aspect-[16/9] mt-8 md:mt-0 md:h-[70vh] w-full md:w-[50%] mask-gradient"
        >
            <Geographies
                fill="#06B6D4"
                stroke="#FFFFFF"
...
function ContactForm() {
    ...
    return (
        <Form {...form}>
            <form ref={formRef} onSubmit={form.handleSubmit(onSubmit)} className=" w-full md:w-[50vw]  flex flex-col items-center justify-center space-y-5 md:space-y-10  rounded-2xl p-2 md:p-20 "
            >
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className="w-full">
                            <FormControl>
                                <Input className="dark:text-white dark:placeholder:text-white  border-cyan-500" placeholder={t("emailLabel")} {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className="w-full">
                            <FormControl>
                                <Textarea className="dark:text-white dark:placeholder:text-white resize-none border-cyan-500 h-32 overflow-y-auto" placeholder={t("messageLabel")} {...field} />
                            </FormControl>
                            <FormMessage />
                ...
                />
                <Button
                    className="relative bg-amber-300 text-cyan-900 font-medium border-none rounded-xl px-4 py-2 w-[200px]
             hover:bg-gradient-to-r from-amber-400 to-yellow-300 cursor-pointer shadow-md
